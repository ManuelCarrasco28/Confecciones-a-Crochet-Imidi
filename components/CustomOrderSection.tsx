...
export function CustomOrderSection() {
  ...
  return (
    <section id="pedidos-a-medida" className="py-20 bg-white border-t border-b border-[#C4D8D9] text-[#213B3E] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#F8F5EF] p-6 sm:p-8 rounded-3xl border border-[#C4D8D9] shadow-lg relative">
